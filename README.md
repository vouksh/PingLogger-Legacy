...
* ![HostNameBox](App/Resources/Help/HostNameBox.jpg)
...
* ![IPAddressBox](App/Resources/Help/IPAddressBox.jpg)
...
* ![Interval](App/Resources/Help/IntervalBox.jpg)
...
* ![WarningThreshold](App/Resources/Help/WarningBox.jpg)
...
* ![localimage](App/Resources/Help/TimeoutBox.jpg)
...
* ![PacketSize](App/Resources/Help/PacketSizeBox.jpg)
...
* ![ExpandBox](App/Resources/Help/ExpandBox.jpg)
  ...
  * ![PingResponseBox](App/Resources/Help/PingResponseBox.jpg)
* ![WatchLogButton](App/Resources/Help/WatchLogButton.jpg)
  ...
  * ![LogViewer](App/Resources/Help/LogViewerControl.jpg)
* ![LogsButton](App/Resources/Help/LogsButton.jpg)
...
* ![ResetCounters](App/Resources/Help/ResetCountersButton.jpg)
...
## Options ## 
* ![AutoUpdate](App/Resources/Help/AutoUpdateOption.jpg)
...
* ![StartAllLoggers](App/Resources/Help/StartOnAppStartOption.jpg)
  * If this is checked, all hosts will start as the program loads up, so you don't have to do it manually.
* ![LoadWithWindows](App/Resources/Help/LoadWithWindowsOption.jpg)
...
* ![StartMinimized](App/Resources/Help/StartMinimizedOption.jpg)
...
* ![DaysToKeepLogs](App/Resources/Help/KeepLogsOption.jpg)
  * The rolling number of days to keep log files. Defaults to 7 days.
* ![ThemeChanger](App/Resources/Help/ThemeOption.jpg)
  * 3 options: Auto, Dark, and Light.
  * Auto will pick a theme based on your Windows settings.
* ![StartStopButtons](App/Resources/Help/StartStopAllButtons.jpg)
...
* Access it by clicking the Run Trace Route button ![RunTraceRoute](App/Resources/Help/RunTraceButton.jpg)
* In the new window, click Run Trace to see the hops that are being taken to reach the destination.
  * ![TraceRouteControl](App/Resources/Help/TraceRouteControl.jpg)
* It will do a quick normal ping, then start tracing through the hops. 
* Clicking the small plus sign ![PlusSign](App/Resources/Help/TracePlus.jpg) will add that host/IP to the main window so that you can start logging pings against that as well. 
